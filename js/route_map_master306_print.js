...
(function () {
  ...
  console.log("[route_map] master304 print loaded");
  ...
  function ensurePrintStyles() {
    ...
    style.textContent = `
      ...
      .svingom-print-qr-box{position:relative;width:22mm;height:22mm;display:flex;align-items:center;justify-content:center;background:#fff}
      .svingom-print-qr-box>img:not(.svingom-print-qr-logo),.svingom-print-qr-box>canvas{width:22mm!important;height:22mm!important}
      .svingom-print-qr-logo{position:absolute;z-index:3;width:7mm!important;height:7mm!important;object-fit:contain;background:#fff;padding:.7mm;box-sizing:border-box}
      .svingom-print-url{font-size:8px;max-width:34mm;overflow-wrap:anywhere}
      .svingom-print-logo-space{width:35mm;text-align:right;font-size:8px;color:#8b8178}
      ...
      @media print{
        ...
        .svingom-print-sheet{width:210mm!important;height:297mm!important;min-height:297mm!important;margin:0!important;padding:8mm!important;box-sizing:border-box!important;box-shadow:none!important;transform:none!important;zoom:1!important;overflow:hidden!important;break-after:avoid;page-break-after:avoid}
      }
    `;
    ...
    preview.innerHTML = `
      ...
      <main class="svingom-print-sheet">
        ...
        <footer class="svingom-print-footer">
          ...
          <div class="svingom-print-logo-space"></div>
        </footer>
      </main>
    `;

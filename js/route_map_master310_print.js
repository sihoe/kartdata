...
(function () {
  ...
  console.log("[route_map] master309 print loaded");
  ...
  function ensurePrintStyles() {
    ...
    style.textContent = `
      ...
      .svingom-print-footer{display:grid;grid-template-columns:18mm minmax(0,1fr) 38mm;gap:5mm;align-items:center;border-top:1px solid #d7cec3;padding-top:2mm;min-height:0}
      .svingom-print-info-block{align-self:center;min-width:0}
      ...
      .svingom-print-route-note{font-size:8px;line-height:1.25;color:#645356;margin-top:2mm;white-space:nowrap}

...
(function () {
  ...
  console.log("[route_map] master310 print loaded");
  ...
  const infoTexts = {
    no: {
      ...
      detailIntro: "Utsnittene overlapper. Følg kilometermerkene og pilene i sykkelretningen.",
      detailPart: "Del",
    ...
    en: {
      ...
      detailIntro: "The sections overlap. Follow the kilometre markers and arrows in the direction of travel.",
      detailPart: "Part",
    ...
    de: {
      ...
      detailIntro: "Die Ausschnitte überlappen sich. Folgen Sie den Kilometermarkierungen und Pfeilen in Fahrtrichtung.",
      detailPart: "Teil",

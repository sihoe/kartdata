...
(function () {
  ...
  console.log("[route_map] master311 print loaded");
  ...
  const infoTexts = {
    no: {
      ...
      detailScale: "Ca. målestokk 1:50 000",
    ...
    en: {
      ...
      detailScale: "Approx. scale 1:50,000",
    ...
    de: {
      ...
      detailScale: "Ca. Maßstab 1:50.000",
      ...
      if (n % 2 === 0) {
        ...
        sheet.innerHTML = `
          <header class="svingom-detail-heading">
            <h2>${t.detailTitle}</h2>
            <p>${t.detailIntro}<br><strong>${t.detailScale}</strong></p>
          </header>
